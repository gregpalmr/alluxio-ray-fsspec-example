#!/bin/bash 
# SCRIPT: bootstrap-grafana.sh (/bootstrap.sh)
#
# DESCR:  Initialize Grafana environment
#
...
cp /tmp/config-files/grafana/alluxio_enterprise_dashboard.json /var/lib/grafana/alluxio_dashboards/
...
# Begin Grafana /run.sh script content:
